...
var _createReactElement = require('./utils/createReactElement');
...
function mountComponents() {
  (0, _jquery2.default)('[data-react-component]').each(function (index, el) {
    ...
    (0, _jquery2.default)(el).attr('id', 'react-component-name-' + index);
    var domNodeId = (0, _jquery2.default)(el)[0];

    var reactElementOrRouterResult = (0, _createReactElement2.default)(componentName, props, domNodeId);
    _reactDom2.default.render(reactElementOrRouterResult, domNodeId);
  });
}
...
require.register("assets/components/pages/index.jsx", function(exports, require, module) {
'use strict';
...
;require.register("assets/components/pages/indexSecond.jsx", function(exports, require, module) {
'use strict';
...
;require.register("assets/components/pages/show.jsx", function(exports, require, module) {
'use strict';
...
var _reactComponent = require('./utils/reactComponent');
...
var _show = require('./pages/show');

var _show2 = _interopRequireDefault(_show);

var _indexSecond = require('./pages/indexSecond');

var _indexSecond2 = _interopRequireDefault(_indexSecond);
...
function registerComponent() {
	_reactComponent2.default.register({
		IndexComponent: _index2.default,
		ShowComponent: _show2.default,
		IndexSecondComponent: _indexSecond2.default
	});
}
